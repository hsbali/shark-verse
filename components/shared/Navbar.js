...
const Navbar = () => {
  return (
    <nav
      id="main-nav"
      className="flex items-center justify-between fixed z-50 bg-sky-100/90 w-full p-4"
    >
      <div className=''>
        <ul className="items-center gap-12 uppercase hidden md:flex">
          <li>
          ...
          <li>
            <div className='relative'>
              <small className='absolute text-red-400 bottom-full right-0 font-medium text-xs'>Soon!</small>
              <a className='text-blue-400' href="/#mint">Mint</a>
            </div>
          </li>
        </ul>
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
      ...
      <div>
        <button className="bg-blue-900 p-2 text-white rounded-md font-medium">
