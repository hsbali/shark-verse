      ...
      >
        <div className="text-left">
          <h4 className="text-xl font-bold text-white">
            Shark<span className="text-sky-200 font-normal">Verse</span>
          </h4>
          ...
          <ul className="md:hidden flex gap-6 pt-4">
            <div className="">
              <Link href="/#" passHref>
                <img src="/icons/instagram-white.png" width={18} />
              </Link>
            </div>
            <div>
              <Link href="/#" passHref>
                <img src="/icons/twitter-white.png" width={18} />
              </Link>
            </div>
            <div>
              <Link href="/#" passHref>
                <img src="/icons/opensea-white.png" width={18} />
              </Link>
            </div>
            <div>
              <Link href="/#" passHref>
                <img src="/icons/discord-white.png" width={18} />
              </Link>
            </div>
          </ul>
        </div>
